package com.meditatenowPainRelief.api;
...
public class MNAudioManager {
	...
	public MNAudioManager() {
		addAudio(R.raw.one_introduction, (2*60 + 15)*1000 + 500, "1. Pain Relief Introduction.mp3", "Settle...");
		addAudio(R.raw.two_pain_relief_instructions, (5*60 + 3)*1000 + 500, "2. Pain Relief Instructions.mp3", "Focus...");
		addAudio(R.raw.three_pain_relief_lesson, (1*60 + 23)*1000 + 500, "3. Pain Relief Lesson.mp3", "Breathe...");
	}
